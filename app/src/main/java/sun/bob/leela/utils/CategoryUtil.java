...
public class CategoryUtil {
    ...
    public void initBuiltInCategories(){
        ...
        cat.setId(AppConstants.CAT_ID_ALL);
        cat.setIcon("icon_category/cat_all.png");
...
//        helper.saveCategory(cat);
        ...
        cat.setName("Company");
        cat.setType(AppConstants.CAT_TYPE_BUILTIN);
        cat.setId(AppConstants.CAT_ID_COMPANY);
        cat.setIcon("icon_category/cat_company.png");
        helper.saveCategory(cat);
    }
    ...
    public void initBuiltInTypes (){
        ...
        AcctType toAdd;
        try {
            for (String file : context.getAssets().list("cat_all")) {
                if (file.endsWith(".png")) {
                    toAdd = new AcctType();
                    toAdd.setName(file.replace(".png", ""));
                    toAdd.setCategory(AppConstants.CAT_ID_ALL);
                    toAdd.setIcon("cat_all/" + file);
                    helper.save(toAdd);
                }
            }
