...
public class AcctListFragment extends Fragment {
    ...
    private static final String ARG_KEYWORD = "keyword_param";
    ...
    public static AcctListFragment newInstance(Long category, String searchKeyWord) {
        AcctListFragment fragment = new AcctListFragment();
        Bundle args = new Bundle();
        args.putLong(ARG_CATEGORY, category);
        args.putString(ARG_KEYWORD, searchKeyWord);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            searchKeyWord = getArguments().getString(ARG_KEYWORD);
        }
    }
