...
public class DetailActivity extends AppCompatActivity {
    ...
    private AppCompatImageView webSiteContainer;
    ...
    private void wireUpViews(){
        ...
        webSiteContainer = (AppCompatImageView) findViewById(R.id.website_ic);
        ...
        copyOnTouchListener copyListener = new copyOnTouchListener();
        tvTitle.setOnTouchListener(copyListener);
        tvAccount.setOnTouchListener(copyListener);
        tvPasswd.setOnTouchListener(copyListener);
        tvAdditional.setOnTouchListener(copyListener);
        tvWebSite.setOnTouchListener(copyListener);
        tvLastAccess.setOnTouchListener(copyListener);
    ...
    class copyOnTouchListener implements View.OnTouchListener{
        @Override
        public boolean onTouch(View v, MotionEvent event) {
            AppCompatTextView view = (AppCompatTextView)v;
            clipboard.setText(view.getText());
